        ...
        function(entity_a)
            ...
            entities:for_each(
                function(entity_b)
                    ...
                    if collider_a.is_colliding or collider_b.is_colliding then
                        goto continue
                    end
...
function CollisionSystem:GetCenter( entity )
    ...
    local spriteCenter = vec2(sprite.width/2, sprite.height/2)
    local center = transform.position + spriteCenter
