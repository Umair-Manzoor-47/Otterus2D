...
namespace otterus_rendering {
	/// <summary>
	/// 1. Allocate 4 vertices for each glyph.
	/// 2. Create a batch starting at offset 0.
	/// 3. For each glyph:
	///    - Copy its 4 corner vertices.
	///    - Add 6 indices (2 triangles).
	/// 4. Bind the VBO and orphan its old data.
	/// 5. Upload the new vertex data.
	/// 6. Unbind the VBO.
	/// </summary>
