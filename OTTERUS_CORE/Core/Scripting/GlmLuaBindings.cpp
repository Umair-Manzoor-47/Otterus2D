...
namespace otterus_core::Scripting {
	...
	void CreateVec2Bind(sol::state& lua) 
	{
		...
		auto vec2_mulitplication_overloads = sol::overload(
		...
		// division overloads
		auto vec2_division_overloads = sol::overload(
			[](const glm::vec2& v1, const glm::vec2& v2) { return v1 / v2; },
			[](const glm::vec2& v1, float value) { return v1 / value; },
			[](float value, const glm::vec2& v1) { return v1 / value; }
		);
		...
		lua.new_usertype<glm::vec2>(
			...
			"x", &glm::vec2::x,
			"y", &glm::vec2::y,
			sol::meta_function::multiplication, vec2_mulitplication_overloads,
			sol::meta_function::division, vec2_division_overloads,
	...
	{
		// multiplication overloads
		auto vec3_mulitplication_overloads = sol::overload(
		...
		// division overloads
		auto vec3_division_overloads = sol::overload(
			[](const glm::vec3& v1, const glm::vec3& v2) { return v1 / v2; },
			[](const glm::vec3& v1, float value) { return v1 / value; },
			[](float value, const glm::vec3& v1) { return v1 / value; }
		);
		...
		lua.new_usertype<glm::vec3>(
			...
			"y", &glm::vec3::y,
			"z", &glm::vec3::z,
			sol::meta_function::multiplication, vec3_mulitplication_overloads,
			sol::meta_function::division, vec3_division_overloads,
	...
	{
		// multiplication overloads
		auto vec4_mulitplication_overloads = sol::overload(
		...
		// division overloads
		auto vec4_division_overloads = sol::overload(
			[](const glm::vec4& v1, const glm::vec4& v2) { return v1 / v2; },
			[](const glm::vec4& v1, float value) { return v1 / value; },
			[](float value, const glm::vec4& v1) { return v1 / value; }
		);
		...
		lua.new_usertype<glm::vec4>(
			...
			"z", &glm::vec4::z,
			"w", &glm::vec4::w,
			sol::meta_function::multiplication, vec4_mulitplication_overloads,
			sol::meta_function::division, vec4_division_overloads,
